...
One page per menu item, added as each is implemented. See the
top-level README for the current phase status.

- [01-install.md](01-install.md) — menu 1
- [02-tang-server-config.md](02-tang-server-config.md) — menu 2
- [03-tang-bindings.md](03-tang-bindings.md) — menu 3
- [04-luks-setup.md](04-luks-setup.md) — menu 4
